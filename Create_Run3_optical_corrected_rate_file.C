...
// "+Q", "-Q", "+beta", "-beta", "dQip"
{
  ...
  for(Int_t scan=0; scan<2;scan++) {
    ...
    // -- names of rate files
    sprintf(file_name_rate_x,"../Fill-%d/IntensityCorrFBCTRate_aodFT0_x_Scan_%d.root",
	     g_vdm_Fill,scan);
    sprintf(file_name_rate_y,"../Fill-%d/IntensityCorrFBCTRate_aodFT0_y_Scan_%d.root",
	     g_vdm_Fill,scan);
    // -- names of new rate files
    sprintf(file_name_new_rate_x,"../Fill-%d/OpticalIntensityCorrFBCT%sRate_aodFT0_x_Scan_%d.root",
	     g_vdm_Fill,sys_opt,scan);
    sprintf(file_name_new_rate_y,"../Fill-%d/OpticalIntensityCorrFBCT%sRate_aodFT0_y_Scan_%d.root",
	     g_vdm_Fill,sys_opt,scan);
